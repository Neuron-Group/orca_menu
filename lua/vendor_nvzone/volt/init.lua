...
local draw = require "vendor_nvzone.volt.draw"
local state = require "vendor_nvzone.volt.state"
local utils = require "vendor_nvzone.volt.utils"
...
M.run = function(buf, opts)
  ...
  require "vendor_nvzone.volt.highlights"
  ...
  if not vim.g.extmarks_events then
    require("vendor_nvzone.volt.events").enable()
  end
end
